...
// const someTextNo = (`yes' is wrong answer ;(. Correct answer was 'no'. Let's try again, ${nameObj}!`);
// const someTextElse = (`'no' is wrong answer ;(. Correct answer was 'yes'. Let's try again, ${nameObj}!`);
